 ...
 *
 * "Unmanaged" here means unmanaged *by Pulumi*. The IONOS VPS runs NixOS from
 * this very flake (`modules/hosts/ionos-vps.nix`), so its software is fully
 * declarative — it is only the machine's existence, addresses and firewall that
 * no tool here can reconcile, because the Cloud Panel has no API.
 *
