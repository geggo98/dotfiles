{ pkgs, lib, ... }:
{
  ...
  # sudo chmod +a "${USER} allow read,write,execute,delete,readattr,writeattr,readextattr,writeextattr,chown,add_file,add_subdirectory,delete_child,file_inherit,directory_inherit" /nix/store
