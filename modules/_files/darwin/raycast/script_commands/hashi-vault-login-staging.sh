...
# @raycast.description Login to the staging Vault with Hashi Vault CLI, opens a web browser.
...
exec "/etc/profiles/per-user/${USER}/bin/+vault-login-staging"
