...
ASSIGNEE_ALIAS = {
    "alex": "712020:00000000-0000-4000-8000-000000000000",
}
...
def require_key(key: str | None, cmd: str) -> str:
    ...
    if not key:
        raise SkillError(f"{cmd} requires an issue key (e.g. JIRA-1234)", 1)
...
class Ctx:
    ...
    def client(self) -> JiraClient:
        if self._client is None:
            url = _resolve(["JIRA_URL"], ["jira_url"], "https://example.atlassian.net")
            ...
            url = (url or "https://example.atlassian.net").rstrip("/")
